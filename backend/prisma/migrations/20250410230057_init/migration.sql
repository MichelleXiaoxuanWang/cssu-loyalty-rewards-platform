...
CREATE TABLE "Promotion" (
    ...
    "startTime" DATETIME NOT NULL,
    "endTime" DATETIME NOT NULL,
    "minSpending" REAL NOT NULL DEFAULT 0.00,
...
-- CreateTable
CREATE TABLE "_PromotionsApplied" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,
    CONSTRAINT "_PromotionsApplied_A_fkey" FOREIGN KEY ("A") REFERENCES "Promotion" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "_PromotionsApplied_B_fkey" FOREIGN KEY ("B") REFERENCES "Transaction" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);

-- CreateTable
CREATE TABLE "_UsedOneTimePromotions" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,
    CONSTRAINT "_UsedOneTimePromotions_A_fkey" FOREIGN KEY ("A") REFERENCES "Promotion" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "_UsedOneTimePromotions_B_fkey" FOREIGN KEY ("B") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_PromotionsApplied_AB_unique" ON "_PromotionsApplied"("A", "B");

-- CreateIndex
CREATE INDEX "_PromotionsApplied_B_index" ON "_PromotionsApplied"("B");

-- CreateIndex
CREATE UNIQUE INDEX "_UsedOneTimePromotions_AB_unique" ON "_UsedOneTimePromotions"("A", "B");

-- CreateIndex
CREATE INDEX "_UsedOneTimePromotions_B_index" ON "_UsedOneTimePromotions"("B");
